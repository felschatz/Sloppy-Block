...
class cloud:
	...
	def __init__(self, WIDTH, HEIGHT):
		"""Constructor for a cloud,
			which will be moving from the right to the left

		INPUT:  WIDTH - The value where the cloud will be initialized.
							Will be randomized
				HEIGHT - The value where the cloud will be initialized.
							Will be randomized
